import { ArrowRight, ArrowUpRight, Code2, ImageIcon } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            ...
            description="A focused selection of published projects, with deeper project review available where the case study is public."
          />

          <Link
            href="/projects"
            className="inline-flex min-h-10 shrink-0 items-center gap-2 self-start rounded-xl border border-border px-4 py-2 text-sm font-semibold text-foreground transition-colors hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none lg:self-auto"
          >
            View all projects
